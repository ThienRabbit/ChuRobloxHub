...
local ThunderImageUI = Instance.new("ImageLabel")
        ...
        ThunderImageUI.Image = "https://cdn.discordapp.com/avatars/669100031894093844/d5da35557fea3567ea2614cf4297e0e4.png?size=4096"
...
_G.Key = ""
_G.Discord = "https://discord.gg/vsFvVqbxyD"
...
function Update:Window(text,logo,keybind)
	local uihide = false
	local abc = false
	local logo = logo or 12947029414
	local currentpage = ""
	local keybind = keybind or Enum.KeyCode.RightControl
	local yoo = string.gsub(tostring(keybind),"Enum.KeyCode.","")
	
	local PADOXHUB = Instance.new("ScreenGui")
	PADOXHUB.Name = "ChuRoblox Hub"
...
Logo.Image = "rbxassetid://12947029414"
    ...
    task.spawn(function()
	  while wait() do
	   ver1.Text = "[S] : "..os.date("%H")..":"..os.date("%M")..":"..os.date("%S")
	end
end)
...
Ping.Parent.Text = ("[Ping] : " ..game:GetService("Stats").Network.ServerStatsItem["Data Ping"]:GetValueString(math.round(2/ping)))
   ...
   UserImageCorner.CornerRadius = UDim.new(0, 100)
    ...
    function setTime()
        ...
        timecock.Text = ("Giờ(s) : "..Hour.." Phút(s) : "..Minute.." Giây(s) : "..Second)
    end
...
spawn(function()
    while wait() do
        if _G.Auto_Farm_Level then
			if _G.Select_Mode_Farm == "Chế Độ Cày Cấp Độ" then
				pcall(function()
			...
			elseif _G.Select_Mode_Farm == "Chế Độ Nhanh" then
				pcall(function()
            ...
            elseif _G.Select_Mode_Farm == "Không Nhận Nhiệm Vụ" then
				pcall(function()
                	CheckQuest()
					if game:GetService("Workspace").Enemies:FindFirstChild(Ms) then
						for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
...
elseif _G.Select_Mode_Farm == "Farm Gần " then
  for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
...
Setting:Button("Sao Chép Link Discord",function()
 ...
 setclipboard("https://discord.gg/vsFvVqbxyD")
 end)

Setting:Seperator(" Setting ")
Setting:Toggle("Tự động đặt điểm hồi sinh",true,function(value)
...
Setting:Toggle("Chống Bị Khoá Acc (Reset Lv, Ban VV)",true,function(value)
 _G.AFK = value
 end)

if not game:GetService("UserInputService").TouchEnabled and not game:GetService("UserInputService").KeyboardEnabled == false then
_G.DistanceMob = 20
Setting:Slider("Khoảng Cách Cày",1,100,20,function(value)
 _G.DistanceMob = value
 end)
else
 _G.DistanceMob = 20
Setting:Slider1("Khoảng Cách Đánh",1,100,20,function(value)
 _G.DistanceMob = value
 end)
end

Setting:Dropdown("Chọn Phương Pháp Cày", {
 "Phía Sau","Dưới","Trên"
},function(value)
 _G.Method = value
end)
...
spawn(function()
	while task.wait() do
		pcall(function()
			if _G.Auto_Farm_Level and _G.Select_Mode_Farm == "Gần Chế Độ Cày" then
				for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
					if v.Name == Ms and (v.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 350 then
						v.Humanoid.WalkSpeed = 0
						v.Humanoid.JumpPower = 0
...
Setting:Toggle("Gom Quái [Bình Thường]",true,function(value)
...
Setting:Toggle("Gom Quái [Extra+Lag]",false,function(value)
 _G.BringExtra = value
end)
...
Setting:Toggle("Tự Động Lấy Ken Haki",_G.Auto_Ken,function(vu)
	_G.Auto_Ken = vu
end)
spawn(function()
	while wait(2) do
...
Setting:Toggle("Tự Động Nhấp",false,function(value)
 _G.click = value
end)

Setting:Toggle("Văn Bản Thiệt Hại Bị Vô Hiệu Hóa",_G.DisableDamage,function(value)
...
Setting:Toggle("Màn Hình Trắng [ Treo Hạn Chế Văng ]",_G.WhiteScreen,function(value)
 ...
 game:GetService("RunService"):Set3dRenderingEnabled(true)
    ...
    Setting:Button("Tăng FPS",function()
        pcall(function()
...
Setting:Seperator("Thông Thạo Cài Đặt")

if not game:GetService("UserInputService").TouchEnabled and not game:GetService("UserInputService").KeyboardEnabled == false then
_G.Kill_At = 25
Setting:Slider("Kill Health [Thông Thạo]",1,100,25,function(value)
 _G.Kill_At = value
end)
else
_G.Kill_At = 25
Setting:Slider1("Kill Health [Thông Thạo]",1,100,25,function(value)
 _G.Kill_At = value
end)
end

Setting:Toggle("Kĩ Năng Z",true,function(a)
		_G.SkillZ = a
	end)
	Setting:Toggle("Kĩ Năng X",true,function(a)
		_G.SkillX = a
	end)
	Setting:Toggle("Kĩ Năng C",true,function(a)
		_G.SkillC = a
	end)
	Setting:Toggle("Kĩ Năng V",true,function(a)
		_G.SkillV = a
	end)

Main:Seperator("Server")

Time = Main:Label("Thời Gian Dùng Script")
...
local Minute = math.floor(GameTime/(60^1))%60
local Second = math.floor(GameTime/(60^0))%60
Time:Set("[Thời Dùng Script] : Giờ : "..Hour.."Phút : "..Minute.." Giây : "..Second)
end
...
Client:Refresh("[Fps Hiện Tại] : "..Fps)
end
...
Client1:Refresh("[Ping Độ Trễ] : "..Ping)
end
...
Main:Button("Dừng Teleport",function()
  topos(game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame)
  _G.Clip = false
  end)

Main:Seperator(" Trang Chủ ")

Main:Dropdown("Chọn Chế Độ", {
 "Cày Cấp Độ","Chế Độ Nhanh","Không Nhận Nhiệm Vụ","Gần Chế Độ Cày"
},function(value)
 _G.Select_Mode_Farm = value
end)

Main:Toggle("Tự Động Cày Cấp Độ",_G.Auto_Farm_Level,function(value)
...
Main:Seperator("Tự Động Sang Thế Giới Mới")

Main:Toggle("Tự Động Sang Sea 3",_G.Auto_Third_World,function(value)
 _G.Auto_Third_World = value
 StopTween(_G.Auto_Third_World)
 end)

Main:Seperator("Ngoại Chất")

Main:Toggle("Tự Động Cài Ngoại Chất",_G.Auto_Farm_Ectoplasm,function(value)
 _G.Auto_Farm_Ectoplasm = value
 StopTween(_G.Auto_Farm_Ectoplasm)
 end)

Main:Seperator("Nhà Máy")

Main:Toggle("Tự Động Đánh Nhà Máy (Sea 2)",_G.AutoFactory,function(value)
...
Main:Seperator("Sang Sea 2")

Main:Toggle("Tự Động Sang Sea 2",_G.Auto_New_World,function(value)
...
Main:Toggle("Tự Động Đánh Quái",_G.AutoFarmSelectMonster,function(vu)
...
Main:Seperator("Cày Thông Thạo Trái Blox/Súng")
 
Main:Toggle("Tự Động Cày Thông Thạo Blox",_G.AutoFarmFruitMastery,function(value)
 ...
 spawn(function()
  game:GetService("RunService").RenderStepped:Connect(function()
   pcall(function()
    ...
    if string.find(v.Text,"Kĩ Năng Khoá!") then
    v:Destroy()
    end
    end
    end
 ...
 Main:Toggle("Tự Động Cày Thông Thạo Súng",_G.AutoFarmGunMastery,function(value)
...
Main:Toggle("Tự Động Đánh Boss",_G.Auto_Farm_Boss,function(value)
 _G.Auto_Farm_Boss = value
 end)

Main:Toggle("Tự Động Đánh Boss Có NV",true,function(value)
...
Main:Toggle("Tự Động Cày Tất Cả Boss",_G.Auto_Farm_All_Boss,function(value)
...
Main:Seperator(" Nguyên Vật Liệu ")
 
 local SelectMaterial = Main:Dropdown("Chọn Vật Liệu",MaterialMethod,function(value)
 _G.SelectMaterial = value
end)

Main:Toggle("Tự Động Lấy Vật Liệu Đã Chọn",_G.AutoFarmMaterial,function(t)
...
spawn(function()
			while task.wait() do
				if _G.BringNormal and _G.Select_Mode_Farm == "Gần Chế Độ Cày" then
					pcall(function()
						for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
...
Main:Toggle("Tự Động Tìm Đảo Bí Ẩn",false,function(value)
...
Main:Toggle("Tự Động Đổi Máy Chủ Tìm Đảo Bí Ẩn",false,function(value)
 _G.Mystichop = value
end)

Main:Seperator(" Nhặt Rương ")

Main:Toggle("Tự Động Nhặt Rương(Siu Nhanh)",false,function(vu)
	_G.ChestBypass = vu
end)
...
Main:Toggle("Tự Động Lấy Rương Tween",_G.Grab_Chest,function(vu)
	Grab_Chest = vu
    StopTween(Grab_Chest)
	_G.Grab_Chest = vu
end)

Main:Button("Dịch Chuyển Tới Rương",function()
...
Main:Toggle("Tự Động Cày Xương",_G.Auto_Farm_Bone,function(value)
 _G.Auto_Farm_Bone = value
 StopTween(_G.Auto_Farm_Bone)
 end)

Main:Toggle("Tự Động Random Xương",_G.Auto_Trade_Bone,function(value)
...
Main:Button("Kiểm Tra Xương", function()
 game.StarterGui:SetCore("SendNotification", {
  Title = "Kiểm Tra Xương...",
  Text = ("Xương Của Bạn : "..(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Bones","Check")))
 })
 wait(1)
end)
end

Main:Seperator(" Quan Sát ")
...
spawn(function()
	while game:GetService("RunService").Heartbeat:wait() do
		...
		ObservationLevel:Set("Cấp Độ Haki Quan Sát : "..tostring(value))
	end
end)
    
       Main:Toggle("Tự Động Cày Cấp Độ Haki Quan Sát",_G.AutoObservation,function(value)
    ...
    Main:Toggle("Tự Động Cày Cấp Độ Haki Quan Sát Hop",_G.AutoObservation_Hop,function(value)
...
wait(1)
Notification:Notify(
   {Title = "ChuRoblox Hub", Description = "Cấp Độ Haki (Max)"},
   {OutlineColor = Color3.fromRGB(80, 80, 80),Time = 5, Type = "option"},
   {Image = "https://cdn.discordapp.com/avatars/669100031894093844/d5da35557fea3567ea2614cf4297e0e4.png?size=4096", ImageColor = Color3.fromRGB(255, 84, 84), Callback = function(State) print(tostring(State)) end}
)
                    else
                        if World2 then
...
Main:Seperator(" Giả Tộc V4 ")


Main:Button("Chồn Biến Hình Giả",function()
...
Main:Button("Tộc Người Cá Giả",function()
...
Main:Button("Tộc Bầu Trời Giả",function()
...
Main:Button("Tộc Thỏ Giả",function()
...
Main:Button("Tộc Bóng Tối Giả",function()
...
Main:Button("Tộc Humun Giả",function()
...
Main:Button("Hoạt Hình Mink Dash Giả",function()
 local ReplicatedStorage = game:GetService("ReplicatedStorage")
...
Weapon:Seperator(" Phụ Kiện & Nhiệm Vụ ")
...
local Elite_Hunter_Status = Weapon:Label("Status")
		...
		while wait() do
			pcall(function()
				if game:GetService("ReplicatedStorage"):FindFirstChild("Diablo [Lv. 1750]") or game:GetService("ReplicatedStorage"):FindFirstChild("Deandre [Lv. 1750]") or game:GetService("ReplicatedStorage"):FindFirstChild("Urban [Lv. 1750]") or game:GetService("Workspace").Enemies:FindFirstChild("Diablo [Lv. 1750]") or game:GetService("Workspace").Enemies:FindFirstChild("Deandre [Lv. 1750]") or game:GetService("Workspace").Enemies:FindFirstChild("Urban [Lv. 1750]") then
					Elite_Hunter_Status:Set("Trạng Thái : Elite Xuất Hiện!")	
				else
					Elite_Hunter_Status:Set("Trạng Thái : Elite Chưa Xuất Hiện")	
				end
			end)
		end
	end)
	...
	spawn(function()
		while wait() do
			Total_Elite_Hunter:Set("Thợ Săn Ưu Tú : "..game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("EliteHunter","Progress"))
		end
	end)
	
	Weapon:Toggle("Tự Động Elite",_G.Auto_Elite_Hunter,function(value)
 _G.Auto_Elite_Hunter = value
StopTween(_G.Auto_Elite_Hunter)
end)

	
	Weapon:Toggle("Tự Động Elite Hop",_G.Auto_Elite_Hunter_Hop,function(value)
		...
		while wait() do
			pcall(function()
				if string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 88 then
					Mob_Kill_Cake_Prince:Set("Bị Giết : "..string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"),39,41).." : Kill More")
				elseif string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 87 then
					Mob_Kill_Cake_Prince:Set("Giết : "..string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"),39,40).." : Kill More")
				elseif string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 86 then
					Mob_Kill_Cake_Prince:Set("Giết : "..string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"),39,39).." : More")
				else
					Mob_Kill_Cake_Prince:Set("Boss Xuất Hiện")
				end
			end)
		end
	end)

Weapon:Toggle("Tự Động Lấy Cacao",_G.Auto_Cake_Prince,function(value)
...
StopTween(_G.Auto_Cake_Prince)
	...
	Weapon:Toggle("Tự Động Mở Chip Raid Bột",_G.Auto_Open_Dough_Dungeon,function(value)
...
Weapon:Toggle("Tự Động Lấy Soul Guitar",_G.AutoNevaSoulGuitar,function(value)
...
Weapon:Toggle("Tự Động Lấy Soul Guitar + Đổi Máy Chủ Hop",false,function(value)
  _G.soulGuitarhop = value    
 end)

Weapon:Seperator(" Song Kiếm ")

Weapon:Toggle("Tự Động Lấy Song Kiếm(Lỗi)",_G.AutoCdk,function(value)
 _G.AutoCdk = value
end)
...
Weapon:Seperator(" Kiếm Saber ")

Weapon:Toggle("Tự Động Lấy Kiếm Saber",_G.AutoSaber,function(value)
				_G.AutoSaber = value
			end)
			
			Weapon:Toggle("Tự Động Lấy Saber Hop",_G.AutoSaberHop,function(value)
 ...
 spawn(function()
	...
	Weapon:Toggle("Tự Động Lấy Pole V.1",_G.AutoPole,function(value)
        _G.AutoPole = value
        StopTween(_G.AutoPole)
    end)
    
    Weapon:Toggle("Tự Động Lấy Pole V.1 Hop",_G.AutoPoleHop,function(value)
...
Weapon:Seperator(" Nhiệm Vụ Bartilo ")

Weapon:Toggle("Tự Động Làm Nhiệm Vụ Bartilo",_G.Auto_Bartilo_Quest,function(value)
 _G.Auto_Bartilo_Quest = value
StopTween(_G.Auto_Bartilo_Quest)
end)

Weapon:Seperator(" Tộc V2 ")

Weapon:Toggle("Tự Động Lấy Evo Race [V2]",_G.Auto_Evo_Race_V2,function(value)
...
Weapon:Seperator(" Thanh Kiếm Huyền Thoại ")

Weapon:Toggle("Tự Động Lấy Thanh Kiếm Huyền Thoại",_G.AutoBuyLegendarySword,function(Value)
		...
		Weapon:Toggle("Tự Động Lấy Thanh Kiếm Huyền Thoại Hop",_G.AutoBuySwordHop,function(Value)
...
----Sắp Xong
Weapon:Seperator(" Haki Màu Cường Hóa ")

	Weapon:Toggle("Tự Động Mua Haki",_G.Auto_Buy_Enchancement,function(value)
...
StopTween(_G.Auto_Buy_Enchancement)
	...
	Weapon:Toggle("Tự Động Rengoku",_G.Auto_Rengoku,function(value)
...
StopTween(_G.Auto_Rengoku)
	...
	spawn(function()
		...
		Weapon:Seperator(" Swan ")

Weapon:Toggle("Tự Động Swan",_G.Auto_Swan_Glasses,function(value)
 _G.Auto_Swan_Glasses = value
StopTween(_G.Auto_Swan_Glasses)
end)


	Weapon:Toggle("Tự Động Swan Hop",_G.Auto_Swan_Glasses_Hop,function(value)
 _G.Auto_Swan_Glasses_Hop = value
	...
	spawn(function()
		...
		Weapon:Seperator(" Đinh Ba Rồng ")
	
	Weapon:Toggle("Tự Động Lấy Đinh Ba Rồng",_G.Auto_Dragon_Trident,function(value)
 _G.Auto_Dragon_Trident = value
StopTween(_G.Auto_Dragon_Trident)
end)

	
	Weapon:Toggle("Tự Động Lấy Đinh Ba Rồng Hop",_G.Auto_Dragon_Trident_Hop,function(value)
...
Weapon:Toggle("Tự Động Lấy Soul Reaper",_G.Auto_Soul_Reaper,function(value)
 _G.Auto_Soul_Reaper = value
StopTween(_G.Auto_Soul_Reaper)
end)


Weapon:Toggle("Tự Động Lấy Soul Reaper Hop",_G.Auto_Soul_Reaper_Hop,function(value)
...
StopTween(_G.Auto_Soul_Reaper_Hop)
	...
	Weapon:Toggle("Tự Động Lấy Yama",_G.Auto_Yama,function(value)
	 _G.Auto_Yama = value
	...
	spawn(function()
		...
		Weapon:Seperator(" Haki Cầu Vồng ")
	
	Weapon:Toggle("Tự Động Lấy Haki Cầu Vồng",_G.Auto_Rainbow_Haki,function(value)
 _G.Auto_Rainbow_Haki = value
StopTween(_G.Auto_Rainbow_Haki)
end)

	
	Weapon:Toggle("Tự Động Lấy Haki Cầu Vồng Hop",_G.Auto_Rainbow_Haki_Hop,function(value)
...
StopTween(_G.Auto_Rainbow_Haki_Hop)
	...
	Weapon:Toggle("Tự Động Lấy Canvander",_G.Auto_Canvander,function(value)
 _G.Auto_Canvander = value
StopTween(_G.Auto_Canvander)
end)

	
	Weapon:Toggle("Tự Động Lấy Canvander Hop",_G.Auto_Canvander_Hop,function(value)
...
StopTween(_G.Auto_Canvander_Hop)
	...
	spawn(function()
		...
		Weapon:Seperator(" Double Crochet ")
	
	Weapon:Toggle("Tự Động Lấy Double Crochet",_G.Auto_Twin_Hook,function(value)
 _G.Auto_Twin_Hook = value
StopTween(_G.Auto_Twin_Hook)
end)

	
	Weapon:Toggle("Tự Động Lấy Double Crochet Hop",_G.Auto_Twin_Hook_Hop,function(value)
...
StopTween(_G.Auto_Twin_Hook_Hop)
	...
	spawn(function()
		...
		Weapon:Seperator(" Cung Rắn ")

Weapon:Toggle("Tự Động Lấy Cung Rắn",_G.Auto_Serpent_Bow,function(value)
 _G.Auto_Serpent_Bow = value
StopTween(_G.Auto_Serpent_Bow)
end)

	
	Weapon:Toggle("Tự Động Lấy Cung Rắn Hop",_G.Auto_Serpent_Bow_Hop,function(value)
...
Weapon:Toggle("Tự Động Lấy Tushita Sword",_G.Autotushita,function(value)
...
Weapon:Toggle("Tự Động Ngọn Đuốc Thánh",_G.Auto_Holy_Torch,function(value)
...
Weapon:Toggle("Tự Động Haki Quan Sát V2",_G.AutoObservationHakiV2,function(x)
...
Weapon:Seperator(" Mũ Lính Ngự Lâm ")

Weapon:Toggle("Tự Động Lấy Mũ Lính Ngự Lâm",_G.Auto_Musketeer_Hat,function(value)
...
Weapon:Toggle("Tự Động Superhuman",_G.Auto_Superhuman,function(value)
 _G.Auto_Superhuman = value
end)


Weapon:Toggle("Tự Động Fully Superhuman",_G.Auto_Fully_Superhuman,function(value)
...
Weapon:Toggle("Tự Động Lấy Death Step",_G.Auto_Death_Step,function(value)
...
Weapon:Toggle("Tự Động Lấy Fully Death Step",_G.Auto_Fully_Death_Step,function(value)
...
Weapon:Toggle("Tự Động Sharkman Karate",_G.Auto_SharkMan_Karate,function(value)
...
Weapon:Toggle("Tự Động Fully Sharkman Karate",_G.Auto_Fully_SharkMan_Karate,function(value)
...
Weapon:Toggle("Tự Động Electric Claw",_G.Auto_Electric_Claw,function(value)
...
Weapon:Toggle("Tự Động Dragon Talon",_G.Auto_Dragon_Talon,function(value)
...
Weapon:Toggle("Tự Động God Human",_G.Auto_God_Human,function(value)
...
if World1 or World2 then
    Race:Label("Chỉ Có Ở Biển 3 Hãy Sang Sea 3 Để Hiện")
end

if World3 then
Race:Seperator("Tộc v4")
    
    Race:Button("Dịch Chuyển Đến Thời Gian",function()
  Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875)
    end)
    
Race:Button("Dịch Chuyển Tức Thời Để Kéo Đòn Bẩy",function()
  topos(CFrame.new(28575.181640625, 14936.6279296875, 72.31636810302734))
end)

Race:Button("Chuyển Đổi Thời Gian Tức Thời Để Kéo Căng (Phải Ở Trong Temple Of Time!)",function()
  topos(CFrame.new(28981.552734375, 14888.4267578125, -120.245849609375))
end)
   
   Race:Button("Mở khóa Lever.", function()
...
ProximityPrompt.ActionText = "Bí Mật Nhìn Thấy Bên Trong"
ProximityPrompt.ObjectText = "Một Đòn Bẩy Vô Định Của Thời Gian"
...
Race:Toggle("Cầu Thang Inf", nil, function(value)
	game.Players.LocalPlayer.Character.InfiniteStairs.Disabled = value
end)
   Race:Line()
 
  Race:Button("Dịch Chuyển Cửa Cyborg (Phải Ở Trong Temple Of Time!)",function()
  topos(CFrame.new(28492.4140625, 14894.4267578125, -422.1100158691406))
  end)
  
  Race:Button("Cửa Cá Dịch Chuyển (PhảI Ở Trong Temple Of Time!)",function()
  topos(CFrame.new(28224.056640625, 14889.4267578125, -210.5872039794922))
  end)
  
  Race:Button("Cửa Dịch Chuyển Ghoul (Phải Ở Trong Temple Of Time!)",function()
  topos(CFrame.new(28672.720703125, 14889.1279296875, 454.5961608886719))
  end)
  
  Race:Button("Dịch Chuyển Cánh Cửa Con Người (Phải Ở Trong Temple Of Time!)",function()
  topos(CFrame.new(29237.294921875, 14889.4267578125, -206.94955444335938))
  end)
  
  Race:Button("Dịch Chuyển Cửa Chồn (Phải Ở Trong Temple Of Time!)",function()
  topos(CFrame.new(29020.66015625, 14889.4267578125, -379.2682800292969))
  end)
  
  Race:Button("Cổng Trời Dịch Chuyển (Phải Ở Trong Temple Of Time!)",function()
  topos(CFrame.new(28967.408203125, 14918.0751953125, 234.31198120117188))
  end)
  
  Race:Line()
  
  Race:Button("Dịch Chuyển Đến Vùng An Toàn Khi Pvp(PhảI Ở Trong Temple Of Time!)",function()
  topos(CFrame.new(28273.0859375, 14896.5078125, 157.42063903808594))
  end)
  
  Race:Button("Khu Pvp Dịch Chuyển (Phải Ở Trong Temple Of Time!)",function()
  topos(CFrame.new(28766.681640625, 14967.1455078125, -164.13290405273438))
  end)
  end

Stats:Seperator(" Auto Cộng Điểm Chỉ Số ")

Stats:Toggle("Phòng Thủ",_G.Auto_Stats_Melee,function(value)
...
Stats:Toggle("Tấn Công",_G.Auto_Stats_Defense,function(value)
...
Stats:Toggle("Kiếm",_G.Auto_Stats_Sword,function(value)
...
Stats:Toggle("Súng",_G.Auto_Stats_Gun,function(value)
...
Stats:Toggle("Trái Blox",_G.Auto_Stats_Devil_Fruit,function(value)
...
Stats:Button("Chỉ Số Đền bù",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Bones","Buy",1,2)
  end)

Stats:Slider("Chọn Điểm",1,100,1,function(value)
_G.Point = value
return "Số Điểm : " .. tostring(value)
end)

P:Seperator(" Combats ")

P:Slider("Chọn Khích Cỡ Fov",1,1000,200,function(value)
_G.Select_Size_Fov = value
return "Size Fov : " .. tostring(value)
end)

P:Toggle("Hiện Fov",_G.Show_Fov,function(value)
 _G.Show_Fov = value
end)

P:Toggle("Ghim Đầu Hiện Fov",_G.Aimbot_Skill_Fov,function(value)
 _G.Aimbot_Skill_Fov = value
end)

P:Seperator(" Giết Địch ")
...
Playerslist = {}
    ...
    local SelectedPly = P:Dropdown("Chọn Địch",Playerslist,function(value)
        _G.Select_Player = value
    end)
    
    P:Button("Làm Mới Địch",function()
        Playerslist = {}
        SelectedPly:Clear()
        for i,v in pairs(game:GetService("Players"):GetChildren()) do  
...
P:Toggle("Xem Chế Độ Chơi Địch",_G.Spectate_Player,function(value)
...
P:Toggle("Dịch Chuyển Tới Địch",_G.Teleport_to_Player,function(value)
...
P:Toggle("Tự Động Giết Địch [Melee]",_G.Auto_Kill_Player_Melee,function(value)
...
P:Toggle("Tự Động Giết Địch [Gun]",_G.Auto_Kill_Player_Gun,function(value)
...
Teleport:Seperator(" WORLD ")
 ...
 Teleport:Button("Dịch Chuyển Đến Thế Giới Cũ",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelMain")
  end)
 
 Teleport:Button("Dịch Chuyển Đến Biển Thứ Hai",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelDressrosa")
 end)

 
 Teleport:Button("Dịch Chuyển Đến Biển Thứ Ba",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelZou")
  end)
 
 Teleport:Button("Dịch Chuyển Đến Seabeast",function()
 ...
 Teleport:Seperator(" Hòn Đảo ")
 
 if World1 then
 Teleport:Dropdown("Đến Đảo", {
  "WindMill",
  "Marine",
  "Middle Town",
  "Jungle",
 ...
 Teleport:Toggle("Dịch Chuyển",false,function(value)
 ...
 Teleport:Button("Lập Tức Dịch Chuyển",function()
		 _G.Instant = true
...
if World1 then
    Dungeon:Label("Chuyển Qua Sea 2 Vs Sea 3 Mới Mở Chức Năng Này")
end

if World2 or World3 then
Dungeon:Seperator("Chọn Chips Raid!")
...
Dungeon:Dropdown("Chọn Dungeon",chip,function(value)
 _G.Select_Dungeon = value
end)

Dungeon:Toggle("Auto Mua Chip Dungeon",_G.Auto_Buy_Chips_Dungeon,function(value)
...
Dungeon:Toggle("Tự Động Bất Đầu Raid",_G.Auto_StartRaid,function(value)
...
Dungeon:Toggle("Tự Động Sang Đảo Tiếp Theo",_G.Auto_Next_Island,function(value)
...
Dungeon:Toggle("Tự Động Giết (Raid)",_G.Kill_Aura,function(value)
 _G.Kill_Aura = value  
end)
...
Dungeon:Toggle("Tự Động Đánh Thức",_G.Auto_Awake,function(value)
 _G.Auto_Awake = value 
end)
...
spawn(function()
  ...
  Dungeon:Button("Đảo Tiếp Theo",function()
   pcall(function()
    if game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 5") then
    topos(game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 5").CFrame*CFrame.new(0,70,100))
    elseif game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 4") then
...
Dungeon:Toggle("Tự Động Mua Chip Luật",_G.Auto_Buy_Law_Chip,function(value)
...
Dungeon:Toggle("Tự động bắt đầu Dungeon luật",_G.Auto_Start_Law_Dungeon,function(value)
...
Dungeon:Toggle("Luật Tự Động Giết",_G.Auto_Kill_Law,function(value)
...
spawn(function()
 ...
 _G.SelectFruit = ""
 DevilFruit:Dropdown("Chọn Trái Blox",FruitList,function(value)
  _G.SelectFruit = value
  end)
 
 DevilFruit:Toggle("Tự Động Mua Trái Blox",_G.AutoBuyFruitSniper,function(value)
  _G.AutoBuyFruitSniper = value
  end)
 
 DevilFruit:Seperator(" Khâc ")
 
 DevilFruit:Dropdown("Chọn Trái Blox Để Ăn",FruitList,function(value)
  _G.SelectFruitEat = value
  end)
 
 DevilFruit:Toggle("Tự Động Ăn Trái Blox",_G.AutoEatFruit,function(value)
 ...
 DevilFruit:Toggle("Tự Động Random Trái Ác Quỷ",_G.Random_Auto,function(value)
 ...
 DevilFruit:Button("Trái Cây Ngẫu Nhiên",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Cousin","Buy")
  end)
 
 
 DevilFruit:Toggle("Tự Động Thả Trái Blox",_G.DropFruit,function(value)
  _G.DropFruit = value
  end)
 ...
 DevilFruit:Toggle("Tự Động Bỏ Trái Blox Vào Rương",_G.AutoStoreFruit,function(value)
 ...
 DevilFruit:Toggle("Lấy Trái Blox",_G.BringFruit,function(value)
  _G.BringFruit = value
  pcall(function()
 ...
 DevilFruit:Toggle("Dịch Chuyển Tức Thời Để Lấy Ra Trái Blox",false,function(value)
 _G.Grabfruit = value
end)
...
spawn(function()
 ...
 DevilFruit:Toggle("Lấy Tất Cả Trái Ác Quỷ 75% Tự Kich Khỏi Máy Chủ",_G.BringFruitBF,function(value)
...
if World2 then
		DevilFruit:Button("Dịch Chugei Hoa Đỏ",function()
			for i,v in pairs(game.Workspace:GetDescendants()) do
				if v.Name == "Flower2" then
				    topos(v.CFrame)
				end
		...
		DevilFruit:Button("Dịch Chuyển Hoa Xanh Dương",function()
			for i,v in pairs(game.Workspace:GetDescendants()) do
				if v.Name == "Flower1" then
					topos(v.CFrame)
				end
	...
	DevilFruit:Toggle("Định Vị Vip",false,function(a)
		ESPPlayer = a
		while ESPPlayer do wait()
			UpdatePlayerChams()
		end
	end)
	DevilFruit:Toggle("Định Vị Rương",false,function(a)
		ChestESP = a
		while ChestESP do wait()
			UpdateChestChams() 
		end
	end)
	DevilFruit:Toggle("Định Vị Trái Blox & Phục Sinh",false,function(a)
		DevilFruitESP = a
		while DevilFruitESP do wait()
			UpdateDevilChams() 
		end
	end)
	DevilFruit:Toggle("Định Vị Hoa",false,function(a)
		FlowerESP = a
 ...
 Shop:Button("Mua Geppo",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Geppo")
  end)
 
 Shop:Button("Mua Buso Haki",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Buso")
  end)
 
 Shop:Button("Mua Soru",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Soru")
  end)
 
 Shop:Button("Mua Observation(Ken) Haki",function()
 ...
 Misc:Seperator(" Tham Gia ")
 
 Misc:Button("Tham Cướp Biển",function()
 		local args = {
			[1] = "SetTeam",
			[2] = "Pirates"
		}
...
Misc:Button("Tham Gia Hải Quân",function()
 local args = {
			[1] = "SetTeam",
			[2] = "Marines"
		}
...
Misc:Button("Tham Gia Lại",function()
...
Misc:Button("Đổi Máy Chủ",function()
 hop()
    ...
    Misc:Button("Đổi Máy Chủ Đến Hạ Thủ",function()
...
Misc:Seperator(" Mở Menu ")

Misc:Button("Kho Trái Blox",function()
...
Misc:Button("Tiêu Đề Tên",function()
 local args = {
			[1] = "getTitles"
		}
		game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
...
Misc:Button("Màu Haki",function()
 game.Players.localPlayer.PlayerGui.Main.Colors.Visible = true
end)

Misc:Seperator(" Code Game ")
...
local x2Code = {
 ...
 "Enyu_is_Pro"
    ...
    Misc:Button("Nhập Tất Cả Codes X2",function()
    ...
    Misc:Dropdown("Chọn Code",{"1MLIKES_RESET","THIRDSEA","SUB2GAMERROBOT_RESET1","SUB2UNCLEKIZARU"},function(value)
        _G.CodeSelect = value
    end)
    
    Misc:Button("Mua Code",function()
...
Misc:Seperator(" Linh Tinh ")
    ...
    Misc:Dropdown("Chọn Haki State",{"State 0","State 1","State 2","State 3","State 4","State 5"},function(value)
        _G.SelectStateHaki = value
    end)
    
    Misc:Button("Thay Đổi Buso Haki State",function()
...
Misc:Toggle("Xuyên Tường",_G.No_clip,function(value)
 _G.No_clip = value
end)
...
Misc:Toggle("Né Tránh Không Có Thời Gian Hồi Chiêu",false,function(value)
        nododgecool = value
        NoDodgeCool()
    end)
    
    Misc:Toggle("Cuộc Đua Chủ Động Tự Động",_G.AutoAgility,function(value)
    ...
    Misc:Toggle("khả Năng Vô Hạn",false,function(value)
        InfAbility = value
        if value == false then
            game:GetService("Players").LocalPlayer.Character.HumanoidRootPart:FindFirstChild("Agility"):Destroy()
        end
    ...
    Misc:Toggle("Phạm Vi Quan Sát Vô Hạn",getgenv().InfiniteObRange,function(value)
    ...
    Misc:Toggle("Geppo Vô Hạn",getgenv().InfGeppo,function(value)
    ...
    Misc:Toggle("Đi Trên Nước Bất Tử",true,function(value)
        _G.WalkWater = value
    end)
...
spawn(function()
    ...
    Misc:Toggle("Bay",false,function(value)
        Fly = value
    end)
...
Op:Label("Tên : "..game.Players.LocalPlayer.Name)
...
Op:Label("Tộc : "..game:GetService("Players").LocalPlayer.Data.Race.Value)

Op:Label("Trái Blox : "..game.Players.LocalPlayer.Data.DevilFruit.Value)

Op:Label("Cấp Độ : "..game.Players.localPlayer.Data.Level.Value)

Op:Label("Tiền Thưởng : "..game:GetService("Players").LocalPlayer.leaderstats["Bounty/Honor"].Value)
